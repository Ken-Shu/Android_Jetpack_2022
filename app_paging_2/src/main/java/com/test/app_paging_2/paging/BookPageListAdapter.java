...
import com.test.app_paging_2.R;
import com.test.app_paging_2.model.Book;

public class BookPageListAdapter extends PagedListAdapter<Book, BookPageListAdapter.BookListViewHolder> {

    private Context context;

    public BookPageListAdapter(Context context) {
        super(diffCallback);
