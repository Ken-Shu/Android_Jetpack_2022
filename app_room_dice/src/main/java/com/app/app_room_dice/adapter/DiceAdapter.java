package com.app.app_room_dice.adapter;
...
import com.app.app_room_dice.R;
import com.app.app_room_dice.entity.Dice;

import java.util.List;

// 適配器
// 資料庫的每一筆紀錄 要如何配置到指定的 UI 上面
public class DiceAdapter extends BaseAdapter {

    private List<Dice> diceList;
    private Context context;

    public DiceAdapter(Context context){ // 取的最新環境資訊
        this.context = context;
    }

    public void setDiceList(List<Dice> diceList){ // 取的最新diceList資訊
