package com.homework.app_databinding_recyclerview.adapter;
...
import com.homework.app_databinding_recyclerview.R;
import com.homework.app_databinding_recyclerview.databinding.LayoutItemBinding;
...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.MyViewHolder>{
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        // 因為是 databinding 的機制所以要使用 DataBindUtil.inflate
